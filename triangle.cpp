...
Triangle::Triangle() : m_drawCount(3)
{
    Vertex vertices[3] = { Vertex(Vector3f(-0.5f, 0.0f, 0.0f), Vector3f(1.0f, 0.0f, 0.0f)),
                           Vertex(Vector3f(0.0f, 0.5f, 0.0f), Vector3f(0.0f, 1.0f, 0.0f)),
                           Vertex(Vector3f(0.5f, 0.0f, 0.0f), Vector3f(0.0f, 0.0f, 1.0f)) };
